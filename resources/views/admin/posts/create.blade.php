...
<form action="{{route('admin.posts.store')}}" method="post">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="title" id="title" class="form-control" placeholder="new post" aria-describedby="titleHelper" value="{{old('title')}}">
    ...
    <div class="mb-3">
        ...
        <input type="text" step="0.01" name="sub_title" id="sub_title" class="form-control" placeholder="sub title here..." aria-describedby="sub_titleHelper" value="{{old('sub_title')}}">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="description" id="description" class="form-control" placeholder="type here your description" aria-describedby="descriptionHelper" value="{{old('description')}}">
